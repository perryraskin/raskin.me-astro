...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      primary:
        // "w-full  border border-[1px] dark:border-[2px] border-black/20 dark:border-black/50 dark:bg-white/50 bg-black/60 p-[1px] transition duration-300 ease-in-out ",
        // "w-full border-[1px] border dark:border-[2px] border-black/10 dark:border-black/20 dark:bg-neutral-100 bg-gradient-to-b from-neutral-50/70 to-black dark:from-white/60 dark:to-neutral-100/90 p-[1px] transition duration-300 ease-in-out ",
      ...
      // "w-full border-[1px] dark:border-[2px] border-black/10 dark:border-neutral-950  from-black/70 bg-black/50 dark:bg-neutral-100 p-[1px] transition duration-300 ease-in-out ",
      accent:
...
export interface UnifiedButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: "primary" | "secondary" | "secondary" | "accent" | "destructive" | "minimal" | "icon"
