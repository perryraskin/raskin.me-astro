...
date: March 14, 2020
tags: [nextjs, plaid, financial]
description: Your guide to getting started with Plaid in a Next.js app
---
...
export const client = new plaid.Client(PLAID_CLIENT_ID, PLAID_SECRET, PLAID_PUBLIC_KEY, plaid.environments[PLAID_ENV], {
  version: "2019-05-29",
